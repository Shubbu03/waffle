...
import { bigint, bigserial, check, index, integer, jsonb, pgTable, timestamp, uniqueIndex, uuid, varchar } from "drizzle-orm/pg-core";
...
export const signals = pgTable("signals", {
  ...
  walletId: uuid("wallet_id").notNull().references(() => watchedWallets.id, { onDelete: "restrict" }),
